...
describe Inkoc::TypeSystem::Block do
  ...
  describe '#argument_count_range' do
    it 'returns a range of the possible number of arguments' do
      ...
      block.define_required_argument('foo', Inkoc::TypeSystem::Object.new(name: 'A'))
      block.define_required_argument('bar', Inkoc::TypeSystem::Object.new(name: 'B'))
      block.define_optional_argument('baz', Inkoc::TypeSystem::Object.new(name: 'C'))
