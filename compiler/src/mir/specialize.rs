...
impl<'a, 'b> Specialize<'a, 'b> {
    ...
    fn run(&mut self, mir: &mut Mir, dynamic: &mut Dynamic) {
        ...
        //    .unwrap();
        //let rec_name = rec.name(&self.state.db);
        //
        //println!(
        //    "specialize {}.{} (receiver = ID {}, method = ID {}):",
        //    rec_name,
    ...
    fn call_static(
        ...
        // When calling "drop" on generic types the call itself has no type
