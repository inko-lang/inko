...
pub(crate) const HEADER_TYPE_INDEX: u32 = 0;
pub(crate) const HEADER_REFS_INDEX: u32 = 1;
pub(crate) const HEADER_HEAP_INDEX: u32 = 2;

pub(crate) const TYPE_METHODS_COUNT_INDEX: u32 = 2;
pub(crate) const TYPE_METHODS_INDEX: u32 = 3;
