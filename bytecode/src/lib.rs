...
impl Opcode {
    pub fn from_byte(byte: u8) -> Result<Opcode, String> {
        let opcode = match byte {
            ...
            43 => Opcode::FloatSub,
            44 => Opcode::FloatToBits,
            45 => Opcode::FloatToInt,
            46 => Opcode::FloatToString,
            47 => Opcode::FutureDrop,
            48 => Opcode::FutureGet,
            49 => Opcode::FutureGetFor,
            50 => Opcode::GetConstant,
            51 => Opcode::GetFalse,
            52 => Opcode::GetField,
            53 => Opcode::GetClass,
            54 => Opcode::GetModule,
            55 => Opcode::GetNil,
            56 => Opcode::GetTrue,
            57 => Opcode::GetUndefined,
            58 => Opcode::Goto,
            59 => Opcode::Branch,
            60 => Opcode::BranchResult,
            61 => Opcode::Increment,
            62 => Opcode::IntAdd,
            63 => Opcode::IntBitAnd,
            64 => Opcode::IntBitOr,
            ...
            77 => Opcode::IntShr,
            78 => Opcode::IntSub,
            79 => Opcode::IntToFloat,
            80 => Opcode::IntToString,
            81 => Opcode::IsUndefined,
            82 => Opcode::RefKind,
            83 => Opcode::MoveResult,
            84 => Opcode::ObjectEq,
            85 => Opcode::Panic,
            86 => Opcode::ProcessAllocate,
            87 => Opcode::ProcessGetField,
            88 => Opcode::ProcessSendAsync,
            89 => Opcode::ProcessSend,
            90 => Opcode::ProcessSetField,
            91 => Opcode::ProcessSuspend,
            92 => Opcode::ProcessWriteResult,
            93 => Opcode::Free,
            94 => Opcode::Reduce,
            95 => Opcode::Return,
            96 => Opcode::SetField,
            97 => Opcode::StringByte,
            98 => Opcode::StringConcat,
            99 => Opcode::StringDrop,
            100 => Opcode::StringEq,
            101 => Opcode::StringSize,
            102 => Opcode::Throw,
            103 => Opcode::DecrementAtomic,
            104 => Opcode::ProcessFinishTask,
            105 => Opcode::JumpTable,
            106 => Opcode::Push,
            107 => Opcode::Pop,
            108 => Opcode::FuturePoll,
    ...
    pub fn to_int(self) -> u8 {
        ...
        match self {
            ...
            Opcode::FloatSub => 43,
            Opcode::FloatToBits => 44,
            Opcode::FloatToInt => 45,
            Opcode::FloatToString => 46,
            Opcode::FutureDrop => 47,
            Opcode::FutureGet => 48,
            Opcode::FutureGetFor => 49,
            Opcode::GetConstant => 50,
            Opcode::GetFalse => 51,
            Opcode::GetField => 52,
            Opcode::GetClass => 53,
            Opcode::GetModule => 54,
            Opcode::GetNil => 55,
            Opcode::GetTrue => 56,
            Opcode::GetUndefined => 57,
            Opcode::Goto => 58,
            Opcode::Branch => 59,
            Opcode::BranchResult => 60,
            Opcode::Increment => 61,
            Opcode::IntAdd => 62,
            Opcode::IntBitAnd => 63,
            Opcode::IntBitOr => 64,
            ...
            Opcode::IntShr => 77,
            Opcode::IntSub => 78,
            Opcode::IntToFloat => 79,
            Opcode::IntToString => 80,
            Opcode::IsUndefined => 81,
            Opcode::RefKind => 82,
            Opcode::MoveResult => 83,
            Opcode::ObjectEq => 84,
            Opcode::Panic => 85,
            Opcode::ProcessAllocate => 86,
            Opcode::ProcessGetField => 87,
            Opcode::ProcessSendAsync => 88,
            Opcode::ProcessSend => 89,
            Opcode::ProcessSetField => 90,
            Opcode::ProcessSuspend => 91,
            Opcode::ProcessWriteResult => 92,
            Opcode::Free => 93,
            Opcode::Reduce => 94,
            Opcode::Return => 95,
            Opcode::SetField => 96,
            Opcode::StringByte => 97,
            Opcode::StringConcat => 98,
            Opcode::StringDrop => 99,
            Opcode::StringEq => 100,
            Opcode::StringSize => 101,
            Opcode::Throw => 102,
            Opcode::DecrementAtomic => 103,
            Opcode::ProcessFinishTask => 104,
            Opcode::JumpTable => 105,
            Opcode::Push => 106,
            Opcode::Pop => 107,
            Opcode::FuturePoll => 108,
        }
    }
    ...
    pub fn name(self) -> &'static str {
        match self {
            ...
            Opcode::FloatToBits => "float_to_bits",
...
mod tests {
    ...
    fn test_opcode_from_byte() {
        assert_eq!(Opcode::from_byte(95), Ok(Opcode::Return));
        assert_eq!(
